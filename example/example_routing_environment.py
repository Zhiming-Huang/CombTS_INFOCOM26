#!/usr/bin/env python3
"""
Example: Routing Environment with Network Topology
==================================================

This example demonstrates how to use the RoutingEnvironment for network routing problems.
It creates a 3x3 mesh network where each link is modeled as an arm, and the goal is to
...
def plot_routing_results(results: Dict[str, Any]):
    ...
    output_path = os.path.join(output_dir, 'routing_environment_example.pdf')
...
def main():
    """
    Main function to run the routing environment example.
    """
    print("Routing Environment Example with 3x3 Mesh Network")
    print("=" * 60)
    ...
    print("\nRouting environment example completed!")
