...
1. **Algorithm Comparison**: Performance of all algorithms (CTSB, CombUCB, BG-CTS, CTS-G, CL-SG)
2. **Gamma Comparison**: Effect of different γ values for CTS-G and CL-SG algorithms
