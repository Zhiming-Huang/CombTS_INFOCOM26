...
def setup_routing_environment_4x4():
    """
...
def plot_routing_results_4x4(results: Dict[str, Any]):
    """
    ...
    output_path = os.path.join(output_dir, 'routing_environment_4x4_results.pdf')
...
def main():
    """Main function to run the 4x4 routing environment test."""
    print("Routing Environment Test with 4x4 Mesh Network (Wireless Mesh Network)")
    print("=" * 80)
    
    # Create and visualize the environment
    env = setup_routing_environment_4x4()
    ...
    print(f"Link availability rate: 0.75 (realistic for wireless mesh networks)")
    ...
    # Plot results
    plot_routing_results_4x4(results)
    
    print("\n4x4 routing environment test completed!")
